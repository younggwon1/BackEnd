...
![캡처](https://user-images.githubusercontent.com/42603919/149747636-dce8f56c-35f7-4166-9596-3af915c6bc2d.PNG)
...
- 상위 클래스에 선언된 private 멤버 변수는 하위 클래스에서 접근 할 수 없다.
  - private은 외부 클래스에서 접근할 수 없다. 클래스 내부에서만 사용한다.
- **외부 클래스는 접근 할 수 없지만, <u>하위 클래스는 접근 할 수 있도록 protected 접근 제어자를 사용</u>한다.**
